...
def optimization_MIP(model,
    ...
    def constraints_svm(model, outcome, coefficients, lb=None, ub=None, weight_objective=0):
        '''
    ...
    def constraints_tree(model, outcome, task, tree_table, lb=None, ub=None, M=1e5, weight_objective=0):
        '''
